...
import {IExttload} from "src/interfaces/IExttload.sol";
...
abstract contract Exttload is IExttload {
    ...
    function exttload(StorageKey slot) external view returns (bytes32) {
    ...
    /// @inheritdoc IExttload
    function exttload(StorageKey[] calldata slots) external view returns (bytes32[] memory) {
